    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          {`All Doctors Enquiries (${props.orderCount})`}
        </Typography>
      )}
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_BACKEND_URL}/api/doctorsEnquires/`, {
  ...
  const handleSearch = async (e) => {
    ...
    await axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/api/search/doctorsEnquiry?search=${search}`,
        { withCredentials: true }
      )
      .then((res) => {
        setAllEnquiries();
        ...
        <Box sx={{ width: "100%" }}>
          <Paper elevation={3} sx={{ width: "100%", mb: 2, borderRadius: 1 }}>
            <div className="product-topbar-box vendor-topbar-box ">
              <h3 className="">Doctors Enquiries</h3>
