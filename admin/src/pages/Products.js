...
import ProductTags from './SidebarPages/productpage/ProductTags';
...
{numSelected > 0 ? (
      ...
      >
         <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.setAsNewArrival(props.selected)} >
          <ListItemIcon>
         ...
         <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.removeAsNewArrival(props.selected)} >
          <ListItemIcon>
        ...
        <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.setAsTrendingProducts(props.selected)} >
          <ListItemIcon>
        ...
        <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.removeAsTrendingProducts(props.selected)} >
          <ListItemIcon>
...
export default function EnhancedTable() {
  ...
  const [filters , setFilters ] = useState({by_status:'all',by_category:'all',by_product_status:'all',recentDays:'All'})
...
//========================= GET ALL PRODUCTS =========================
  useEffect(()=>{
    setLoading(true)
    axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/all/products`,{withCredentials:true})
    .then(res=>{
      console.log(res)
...
useEffect(()=>{
  ...
  setLoading(true)
  axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/filter/products?by_category=${filters?.by_category}&by_product_status=${filters?.by_product_status}&date_from=${stateDate[0]?.startDate}&date_to=${stateDate[0]?.endDate}`,{withCredentials:true})
  .then(res=>{
    console.log(res)
    setData(res?.data)
...
//======================== FILTER FOR PRODUCTS ========================
  ...
  const handleSearch = async(e)=>{
    e.preventDefault();
    setLoading(true)
    await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/search/in/products?search=${searchValue}`,{withCredentials:true})
    .then(res=>{
      console.log(res)
      setData(res?.data)
      setProductCount(res?.data?.length)
...
const handleDleteProducts = async(value)=>{
  ...
  await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/delete/product`,{data: value},{withCredentials:true})
  .then(res=>{
    console.log(res)
  setOpenDeleteConfimModal(false); 
  setRender(prev=>!prev)
...
const setAsNewArrival = async(value)=>{
  await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/api/set/products/as/new/arrivals`,{data:value},{withCredentials:true})
  .then(res=>{
    console.log(res);
    setRender(prev=>!prev)
...
const removeAsNewArrival = async(value)=>{
  await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/api/remove/products/as/new/arrivals`,{data:value},{withCredentials:true})
  .then(res=>{
    console.log(res);
    setRender(prev=>!prev)
...
const setAsTrendingProducts = async(value)=>{
  await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/api/set/products/as/trending/products`,{data:value},{withCredentials:true})
  .then(res=>{
    console.log(res);
    setRender(prev=>!prev)
...
const removeAsTrendingProducts = async(value)=>{
  await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/api/remove/products/as/trending/products`,{data:value},{withCredentials:true})
  .then(res=>{
    console.log(res);
    setRender(prev=>!prev)
 ...
 {/* #################### SANCKBAR MESSAGE ######################## */}
  ...
  <div className='product-topbar-btn' >
         ...
         {/*################ ADD PRODUCTS SIDEBAR BUTTON ################*/}
          <SideDrawer state={drawerAddProduct} toggleDrawerClose={handleCloseAddProductSideBar} toggleDrawerOpen={handleOpenAddProductSidebar}
           ComponentData={<AddProducts handleClose={handleCloseAddProductSideBar} />}
           ComponentButton={<Button  className='product-btn' variant="contained" startIcon={<Iconify icon="eva:plus-fill" />}> 
          Add Product
         </Button>} />
         {/*################ ADD PRODUCTS SIDEBAR BUTTON ###############*/}
   ...
   <Button className='search-btn' type="submit"  sx={{mx:2,height:54,px:5}} variant="contained" >
        Search
      </Button>
   </form>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell  style={{textTransform:'capitalize'}} align="left">{row.product_name?.slice(0,22)}{row.product_name?.length > 16 && "..."}  </TableCell>
                      <TableCell  style={{textTransform:'capitalize'}} align="left">{row.product_main_category},{row.product_category},{row.product_subcategory}</TableCell>
