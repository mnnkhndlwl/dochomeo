...
//############################# HANDLE DELETE CATEGORIES FUNCTION #############################
 ...
 {/* #################### SANCKBAR MESSAGE ######################## */}
   ...
   <TextField id="outlined-basic" type="search" fullWidth value={search} onChange={(e)=>setSearch(e.target.value)}  label="Search In Users" placeholder='Search Anything...' variant="outlined"  InputProps={{
          startAdornment: (
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">+91-{row?.phone_number}</TableCell>
                      <TableCell align="left">{row?.email}</TableCell>
