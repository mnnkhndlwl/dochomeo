...
function ProductTags({handleClose}) {
 ...
 {/* #################### SANCKBAR MESSAGE ######################## */}
   ...
   <div className='close_edit_Category ' >
    ...
    <div className='add-category-pad-top-bot'>
        <h2  >
       Create or Edit Product Tags
        </h2>
        <p>  Create and Edit your Product Tags </p>
    </div>
  ...
  <ConfimModal open={openConfimModal} title="Delete" onYes={()=>handleRemoveMainCategoryImage(newMainCategory,userselectedCategory)} message="Do you want to delete?" handleClose={handleCloseMainCategoryConfirmModal}  />
    ...
    <div className='main-category-edit-box' >
      ...
      <div className='flex' style={{paddingBottom:10}} >
       <TextField required fullWidth id="outlined-basic" value={addMainCategory} onChange={(e)=>setAddMainCategory(e.target.value)}  placeholder="Tag Name " variant="outlined" />
      ...
      <div style={{paddingBottom:5,paddingTop:10}}>
        <h4  >
       Edit or Modify Your Product Tags 
        </h4>
             ...
             <input hidden accept="image/*" type="file" name="mainCategoryImage"  onChange={handleMainCategoryFileChange } />
                 ...
                 <h4 style={{paddingBottom:4,paddingTop:6}}>Change Tag Name </h4>
             {/* <label style={{padding:"4px 0px"}} >Main Category  </label> */}
             <TextField 
              fullWidth required id="outlined-basic" value={newMainCategory?.name} onChange={(e)=>{setNewMainCategory((prev)=>({...prev,name:e.target.value}))}} placeholder="Tag Name " variant="outlined" />
