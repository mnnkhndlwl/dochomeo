 ...
 {/* #################### SANCKBAR MESSAGE ######################## */}
  ...
  <ConfimModal open={openConfimModal} title="Delete" onYes={()=>handleRemoveMainCategoryImage(newMainCategory,userselectedCategory)} message="Do you want to delete?" handleClose={handleCloseMainCategoryConfirmModal}  />
    ...
    <div className='main-category-edit-box' >
        ...
        <h4  >
       Add a New Main Categroy
        </h4>
       
    </div>
      {/* <label htmlFor="">Main Category  </label> */}
      <div className='flex' style={{paddingBottom:10}} >
       <TextField required fullWidth id="outlined-basic" value={addMainCategory} onChange={(e)=>setAddMainCategory(e.target.value)}  placeholder="Main Category Name " variant="outlined" />
      ...
      <div style={{paddingBottom:5,paddingTop:10}}>
       ...
       Edit or Modify Your Main Category 
                  ...
                  {mainCategory
                    ...
                    .map((value, index) => (
                      ...
                      <img
                          ...
                          alt="product"
                          // src={noImage}
                          src={ value?.main_category_image?.image_url ? value?.main_category_image?.image_url : noImage
                           }
                        />
             ...
             <input hidden accept="image/*" type="file" name="mainCategoryImage"  onChange={handleMainCategoryFileChange } />
                 ...
                 <h4 style={{paddingBottom:4,paddingTop:22}}>Change Main Category Name </h4>
