          ...
          <Box sx={style}>
            ...
            <div className="enquiry-content-box">
              <p className="enquiry-preview-detail">
                ...
                {props.data !== undefined ? props.data.patientName : ""}
                </span>{" "}
              </p>
              <p className="enquiry-preview-detail">
                Phone Number :{" "}
              ...
              <p className="enquiry-preview-detail">
                Doctor Code :{" "}
                <span className="enquiry-details-preview-content">
                {props.data !== undefined ? props.data.doctorCode : ""}{" "}
                </span>{" "}
              </p>
              <p className="enquiry-preview-detail">
                Doctor Name :{" "}
                <span className="enquiry-details-preview-content">
                {props.data !== undefined ? props.data.doctorName : ""}
                </span>{" "}
              </p>
              <p className="enquiry-preview-detail">
                Date & Time :{" "}
              ...
              <p className="enquiry-preview-detail">
                Consultation Type :{" "}
                <span className="enquiry-details-preview-content">
                {props.data !== undefined ? props.data.consultationType : ""}{" "}
                </span>{" "}
              </p>
